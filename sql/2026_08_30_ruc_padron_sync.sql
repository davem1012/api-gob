...
CREATE TABLE `ruc_padron_staging` (
  ...
  `via_tipo` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `via_nombre` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `zona_codigo` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `zona_tipo` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `dpto` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `manzana` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `kilometro` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
